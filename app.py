...
:root {
    --bg:      #0F0F0F;  /* أسود ناعم */
    --navy:    #F0F0F0;  /* نص أبيض */
    --panel:   #1A1A1A;  /* بانلات رمادي داكن */
    --border:  #2A2A2A;  /* حدود خفيفة */
    --muted:   #888888;  /* نص ثانوي رمادي */
    --teal:    #00C896;  /* أزرار أخضر مينت عصري */
    --teal2:   #00E5A8;  /* hover أفتح */
    --user-bg: #1E1E1E;  /* فقاعة المستخدم */
    --ai-bg:   #161616;  /* فقاعة الـ AI */
}
